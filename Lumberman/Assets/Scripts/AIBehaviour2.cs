...
public class AIBehaviour2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        goalFromClickedNode = GameObject.FindGameObjectWithTag("Connections").GetComponent<PathfindingTileGrid2>().goalNode;
        relativeSpeed = 1f;
    }
    void Update()
    {
        targetNodes = GameObject.FindGameObjectWithTag("Connections").GetComponent<PathfindingTileGrid2>().finalPath;
        FollowPath();
    }
    void SeekTarget()
    {
